...
<?php 
    ...
    if(isset($_GET["id"]) && $_GET["id"] != ""){ 
        $id = $_GET["id"];
        $userID = $_SESSION["UID"];
        $sql = "SELECT * FROM activities WHERE act_id= $id AND userID = $userID";
        //echo $sql . "<br>"; 
...
<div style="padding:0 10px;" id="activitiesDiv"> 
    <h3 align="center">Edit Activity</h3> 
    <p align="center">Required field with mark*</p> 

    <!--action file where the form will be submitted is to my_activities_edit_action.php.  -->
