...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Fetch the previous image file path before updating the record
    ...
    if(isset($_FILES["fileToUpload"]) &&  $_FILES["fileToUpload"]["name"] == ""){
        $sql = "UPDATE activities SET sem= $sem, year ='$year', activities = '$activities',  remark = '$remark' , img_path = '$uploadfileName' WHERE act_id =" . $id . " AND userID = ". $_SESSION["UID"];
    ...
    // Check if there is an image to be uploaded
        ...
        if ($_FILES["fileToUpload"]["size"] > 500000) {
            ...
            if ($uploadOk) {
                $sql = "UPDATE activities SET sem= $sem, year ='$year', activities = '$activities',  
                remark = '$remark' , img_path = '$uploadfileName' WHERE act_id =" . $id . " AND userID = ". $_SESSION["UID"];
